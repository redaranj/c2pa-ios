...
public struct TestResult {
    ...
    public static func success(_ testName: String, _ message: String, details: String? = nil) -> TestResult {
        TestResult(testName: testName, passed: true, message: message, details: details)
    }
    
    /// Create a failure result
    public static func failure(_ testName: String, _ message: String, details: String? = nil) -> TestResult {
