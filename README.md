...
[![Tests](https://github.com/guardianproject/c2pa-ios/actions/workflows/test.yml/badge.svg)](https://github.com/guardianproject/c2pa-ios/actions/workflows/test.yml)
...
```swift
dependencies: [
    .package(url: "https://github.com/redaranj/c2pa-ios.git", from: "0.0.1")
]
```
