...
// each license.
//
//  ManifestValidationResult.swift
//

import Foundation

/// The result of validating a manifest definition.
///
/// `ManifestValidationResult` collects errors and warnings encountered during validation.
...
public struct ManifestValidationResult: Sendable {
    ...
    public static let valid = ManifestValidationResult()
}
